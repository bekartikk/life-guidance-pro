...
as $$
  select
    ...
    ai_memory_snapshots.embedding_vector OPERATOR(extensions.<=>) query_embedding as similarity_distance
  ...
  order by ai_memory_snapshots.embedding_vector OPERATOR(extensions.<=>) query_embedding
